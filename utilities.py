...
def annualize_rets(r, periods_per_year):
    """
    Annualizes a set of returns. This function returns
    the Avergae CAGR (Compounded annual growth return)
    Over the periods selected
    """
...
def plot_ef(
    n_points, er, cov, style=".-", legend=False, show_cml=False, riskfree_rate=0
):
    """
    Plots the multi-asset efficient frontier
    """
